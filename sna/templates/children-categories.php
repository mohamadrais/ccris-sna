			...
			<table class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][14]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][14]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo $Translation['ImageFolder'] . urlencode($record[14]); ?>" data-lightbox="categories-ot_Picture01"><img src="thumbnail.php?i=<?php echo urlencode($record[14]); ?>&t=categories&f=ot_Picture01&v=tv" class="img-thumbnail"></a></td>
