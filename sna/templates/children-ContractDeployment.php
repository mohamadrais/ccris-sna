...
<?php $current_table = 'ContractDeployment'; ?>
<?php
	...
	<div class="col-xs-11 col-md-12">
		...
		<?php if($config['display-add-new']){ ?>
			<?php if(stripos($_SERVER['HTTP_USER_AGENT'], 'msie ')){ ?>
				<a href="<?php echo $parameters['ChildTable']; ?>_view.php?filterer_<?php echo $parameters['ChildLookupField']; ?>=<?php echo urlencode($parameters['SelectedID']); ?>&addNew_x=1" target="_viewchild" class="btn btn-success hspacer-sm vspacer-md"><i class="ti-plus"></i> <?php echo html_attr($Translation['Add New']); ?></a>
			<?php }else{ ?>
			...
			<table class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][18]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][18]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo $Translation['ImageFolder'] . urlencode($record[18]); ?>" data-lightbox="ContractDeployment-ot_Photo01"><img src="thumbnail.php?i=<?php echo urlencode($record[18]); ?>&t=ContractDeployment&f=ot_Photo01&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][19]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][19]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo $Translation['ImageFolder'] . urlencode($record[19]); ?>" data-lightbox="ContractDeployment-ot_Photo02"><img src="thumbnail.php?i=<?php echo urlencode($record[19]); ?>&t=ContractDeployment&f=ot_Photo02&v=tv" class="img-thumbnail"></a></td>
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][20]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][20]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo $Translation['ImageFolder'] . urlencode($record[20]); ?>" data-lightbox="ContractDeployment-ot_Photo03"><img src="thumbnail.php?i=<?php echo urlencode($record[20]); ?>&t=ContractDeployment&f=ot_Photo03&v=tv" class="img-thumbnail"></a></td>
