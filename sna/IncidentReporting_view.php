...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"`IncidentReporting`.`ot_Ref03`" => "ot_Ref03",
		"`IncidentReporting`.`ot_Ref04`" => "ot_Ref04",
		"`IncidentReporting`.`ot_Ref05`" => "ot_Ref05",
		"`IncidentReporting`.`ot_Ref06`" => "ot_Ref06",
		"`IncidentReporting`.`ot_Photo01`" => "ot_Photo01",
		"`IncidentReporting`.`ot_Photo02`" => "ot_Photo02",
		"`IncidentReporting`.`ot_Photo03`" => "ot_Photo03",
		...
		"if(`IncidentReporting`.`ot_ap_filed`,date_format(`IncidentReporting`.`ot_ap_filed`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_filed",
		"if(`IncidentReporting`.`ot_ap_lastmodified`,date_format(`IncidentReporting`.`ot_ap_lastmodified`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_lastmodified"
	);
	...
	$x->SortFields = array(   
		...
		28 => 28,
		29 => '`IncidentReporting`.`ot_ap_filed`',
		30 => '`IncidentReporting`.`ot_ap_lastmodified`'
	);
	...
	$x->QueryFieldsFilters = array(   
		...
		"`IncidentReporting`.`ot_Ref03`" => "Reference_3",
		"`IncidentReporting`.`ot_Ref04`" => "Reference_4",
		"`IncidentReporting`.`ot_Ref05`" => "Reference_5",
		"`IncidentReporting`.`ot_Ref06`" => "Reference_6",
