<?php
	...
	function projects_after_insert($data, $memberInfo, &$args){
		...
		if(function_exists('dbCalendarEvent')){
			dbCalendarEvent($data["Name"], $data["fo_StartDate"], $data["fo_EndDate"], $tableName, $data["Id"], $data["ot_ap_Review"], $data["ot_ap_Approval"], $data["ot_ap_QC"], 'insert');
		}
	...
	function projects_after_update($data, $memberInfo, &$args){
		...
		if(function_exists('dbCalendarEvent')){
			dbCalendarEvent($data["Name"], $data["fo_StartDate"], $data["fo_EndDate"], $tableName, $data["Id"], $data["ot_ap_Review"], $data["ot_ap_Approval"], $data["ot_ap_QC"], 'update');
		}
