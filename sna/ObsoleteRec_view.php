...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"`ObsoleteRec`.`ot_Ref03`" => "ot_Ref03",
		"`ObsoleteRec`.`ot_Ref04`" => "ot_Ref04",
		"`ObsoleteRec`.`ot_Ref05`" => "ot_Ref05",
		"`ObsoleteRec`.`ot_Ref06`" => "ot_Ref06",
		"`ObsoleteRec`.`ot_Photo01`" => "ot_Photo01",
		"`ObsoleteRec`.`ot_Photo02`" => "ot_Photo02",
		"`ObsoleteRec`.`ot_Photo03`" => "ot_Photo03",
		...
		"if(`ObsoleteRec`.`ot_ap_filed`,date_format(`ObsoleteRec`.`ot_ap_filed`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_filed",
		"if(`ObsoleteRec`.`ot_ap_lastmodified`,date_format(`ObsoleteRec`.`ot_ap_lastmodified`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_lastmodified"
	);
	...
	$x->SortFields = array(   
		...
		25 => 25,
		26 => '`ObsoleteRec`.`ot_ap_filed`',
		27 => '`ObsoleteRec`.`ot_ap_lastmodified`'
	);
	...
	$x->QueryFieldsFilters = array(   
		...
		"`ObsoleteRec`.`ot_Ref03`" => "Reference_3",
		"`ObsoleteRec`.`ot_Ref04`" => "Reference_4",
		"`ObsoleteRec`.`ot_Ref05`" => "Reference_5",
		"`ObsoleteRec`.`ot_Ref06`" => "Reference_6",
