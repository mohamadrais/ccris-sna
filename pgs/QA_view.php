...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"`QA`.`ot_Ref03`" => "ot_Ref03",
		"`QA`.`ot_Ref04`" => "ot_Ref04",
		"`QA`.`ot_Ref05`" => "ot_Ref05",
		"`QA`.`ot_Ref06`" => "ot_Ref06",
		"`QA`.`ot_Photo01`" => "ot_Photo01",
		"`QA`.`ot_Photo02`" => "ot_Photo02",
		"`QA`.`ot_Photo03`" => "ot_Photo03",
		...
		"if(`QA`.`ot_ap_filed`,date_format(`QA`.`ot_ap_filed`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_filed",
		"if(`QA`.`ot_ap_last_modified`,date_format(`QA`.`ot_ap_last_modified`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_last_modified"
	);
	...
	$x->QueryFieldsFilters = array(   
		...
		"`QA`.`ot_Ref03`" => "Reference_3",
		"`QA`.`ot_Ref04`" => "Reference_4",
		"`QA`.`ot_Ref05`" => "Reference_5",
		"`QA`.`ot_Ref06`" => "Reference_6",
	...
	$x->ColNumber  = array(2, 3, 4, 6, 7, 8, 23, 25, 27, 29, 30);
