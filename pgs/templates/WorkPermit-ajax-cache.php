...
<script>
	$j(function(){
		...
		var data = {
			WrLocID: <?php echo json_encode(array('id' => $rdata['WrLocID'], 'value' => $rdata['WrLocID'], 'text' => $jdata['WrLocID'])); ?>,
		...
		/* saved value for WrLocID */
		cache.addCheck(function(u, d){
			if(u != 'ajax_combo.php') return false;
			if(d.t == tn && d.f == 'WrLocID' && d.id == data.WrLocID.id)
				return { results: [ data.WrLocID ], more: false, elapsed: 0.01 };
			return false;
		});
