<script>
	$j(function(){
		...
		var data = {
			...
			ResourcesID: <?php echo json_encode(array('id' => $rdata['ResourcesID'], 'value' => $rdata['ResourcesID'], 'text' => $jdata['ResourcesID'])); ?>,
		...
		/* saved value for ResourcesID */
		cache.addCheck(function(u, d){
			if(u != 'ajax_combo.php') return false;
			if(d.t == tn && d.f == 'ResourcesID' && d.id == data.ResourcesID.id)
				return { results: [ data.ResourcesID ], more: false, elapsed: 0.01 };
			return false;
		});
