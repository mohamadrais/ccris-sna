...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"`MonthlyTimesheet`.`ot_Photo`" => "ot_Photo",
		...
		"DATE_FORMAT(`MonthlyTimesheet`.`ot_ap_filed`, '%c/%e/%Y %l:%i%p')" => "ot_ap_filed",
		"DATE_FORMAT(`MonthlyTimesheet`.`ot_ap_lastmodified`, '%c/%e/%Y %l:%i%p')" => "ot_ap_lastmodified"
	);
	...
	$x->SortFields = array(   
		...
		20 => 20,
		21 => '`MonthlyTimesheet`.`ot_ap_filed`',
		22 => '`MonthlyTimesheet`.`ot_ap_lastmodified`'
	);
