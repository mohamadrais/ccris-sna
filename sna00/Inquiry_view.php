...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"DATE_FORMAT(`Inquiry`.`ot_ap_filed`, '%c/%e/%Y %l:%i%p')" => "ot_ap_filed",
		"DATE_FORMAT(`Inquiry`.`ot_ap_lastmodified`, '%c/%e/%Y %l:%i%p')" => "ot_ap_lastmodified"
	);
	...
	$x->SortFields = array(   
		...
		29 => 29,
		30 => '`Inquiry`.`ot_ap_filed`',
		31 => '`Inquiry`.`ot_ap_lastmodified`'
	);
	...
	$x->ColNumber  = array(2, 3, 4, 5, 24, 26, 28, 30, 31);
