...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="Inquiry_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/cash_register.png"> 					Inquiry & Tender Filters</a>
			</h1></div>
			...
			if ($j("#filterfield_3").val().length){
				...
				$j.ajax({
					...
					data: {
						...
						p: 1,                                         //page number
						t: "Inquiry",                //table name
						f: "ClientID"               //field name
					}
