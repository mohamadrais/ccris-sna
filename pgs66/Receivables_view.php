...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"DATE_FORMAT(`Receivables`.`ot_ap_filed`, '%c/%e/%Y %l:%i%p')" => "ot_ap_filed",
		"DATE_FORMAT(`Receivables`.`ot_ap_lastmodified`, '%c/%e/%Y %l:%i%p')" => "ot_ap_lastmodified"
	);
	...
	$x->SortFields = array(   
		...
		23 => 23,
		24 => '`Receivables`.`ot_ap_filed`',
		25 => '`Receivables`.`ot_ap_lastmodified`'
	);
	...
	$x->ColNumber  = array(2, 3, 4, 5, 7, 18, 20, 22, 24, 25);
