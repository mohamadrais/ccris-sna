...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"`QuarterlyMeeting`.`ot_Ref03`" => "ot_Ref03",
		"`QuarterlyMeeting`.`ot_Ref04`" => "ot_Ref04",
		"`QuarterlyMeeting`.`ot_Ref05`" => "ot_Ref05",
		"`QuarterlyMeeting`.`ot_Ref06`" => "ot_Ref06",
		"`QuarterlyMeeting`.`ot_Photo01`" => "ot_Photo01",
		"`QuarterlyMeeting`.`ot_Photo02`" => "ot_Photo02",
		"`QuarterlyMeeting`.`ot_Photo03`" => "ot_Photo03",
		...
		"if(`QuarterlyMeeting`.`ot_ap_filed`,date_format(`QuarterlyMeeting`.`ot_ap_filed`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_filed",
		"if(`QuarterlyMeeting`.`ot_ap_lastmodified`,date_format(`QuarterlyMeeting`.`ot_ap_lastmodified`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_lastmodified"
	);
	...
	$x->SortFields = array(   
		...
		25 => 25,
		26 => '`QuarterlyMeeting`.`ot_ap_filed`',
		27 => '`QuarterlyMeeting`.`ot_ap_lastmodified`'
	);
	...
	$x->QueryFieldsFilters = array(   
		...
		"`QuarterlyMeeting`.`ot_Ref03`" => "Reference_3",
		"`QuarterlyMeeting`.`ot_Ref04`" => "Reference_4",
		"`QuarterlyMeeting`.`ot_Ref05`" => "Reference_5",
		"`QuarterlyMeeting`.`ot_Ref06`" => "Reference_6",
