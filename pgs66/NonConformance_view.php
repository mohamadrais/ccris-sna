...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"concat('<i class=\"glyphicon glyphicon-', if(`NonConformance`.`fo_ClosedIssue`, 'check', 'unchecked'), '\"></i>')" => "fo_ClosedIssue",
		...
		"`NonConformance`.`ot_Ref03`" => "ot_Ref03",
		"`NonConformance`.`ot_Ref04`" => "ot_Ref04",
		"`NonConformance`.`ot_Ref05`" => "ot_Ref05",
		"`NonConformance`.`ot_Ref06`" => "ot_Ref06",
		"`NonConformance`.`ot_Photo01`" => "ot_Photo01",
		"`NonConformance`.`ot_Photo02`" => "ot_Photo02",
		"`NonConformance`.`ot_Photo03`" => "ot_Photo03",
		...
		"if(`NonConformance`.`ot_ap_filed`,date_format(`NonConformance`.`ot_ap_filed`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_filed",
		"if(`NonConformance`.`ot_ap_lastmodified`,date_format(`NonConformance`.`ot_ap_lastmodified`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_lastmodified"
	);
	...
	$x->SortFields = array(   
		...
		29 => 29,
		30 => '`NonConformance`.`ot_ap_filed`',
		31 => '`NonConformance`.`ot_ap_lastmodified`'
	);
	...
	$x->QueryFieldsFilters = array(   
		...
		"`NonConformance`.`ot_Ref03`" => "Reference_3",
		"`NonConformance`.`ot_Ref04`" => "Reference_4",
		"`NonConformance`.`ot_Ref05`" => "Reference_5",
		"`NonConformance`.`ot_Ref06`" => "Reference_6",
	...
	$x->ColNumber  = array(2, 3, 4, 6, 7, 9, 24, 26, 28, 30, 31);
