...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"DATE_FORMAT(`Inventory`.`ot_ap_filed`, '%c/%e/%Y %l:%i%p')" => "ot_ap_filed",
		"DATE_FORMAT(`Inventory`.`ot_ap_last_modified`, '%c/%e/%Y %l:%i%p')" => "ot_ap_last_modified"
	);
	...
	$x->SortFields = array(   
		...
		30 => 30,
		31 => '`Inventory`.`ot_ap_filed`',
		32 => '`Inventory`.`ot_ap_last_modified`'
	);
	...
	$x->ColNumber  = array(2, 3, 5, 6, 9, 12, 25, 27, 29, 31, 32);
