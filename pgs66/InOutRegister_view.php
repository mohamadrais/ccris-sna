...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"`InOutRegister`.`ot_Photo`" => "ot_Photo",
		...
		"DATE_FORMAT(`InOutRegister`.`ot_ap_filed`, '%c/%e/%Y %l:%i%p')" => "ot_ap_filed",
		"DATE_FORMAT(`InOutRegister`.`ot_ap_lastmodified`, '%c/%e/%Y %l:%i%p')" => "ot_ap_lastmodified"
	);
	...
	$x->SortFields = array(   
		...
		20 => 20,
		21 => '`InOutRegister`.`ot_ap_filed`',
		22 => '`InOutRegister`.`ot_ap_lastmodified`'
	);
	...
	$x->ColNumber  = array(2, 3, 5, 15, 17, 19, 21, 22);
