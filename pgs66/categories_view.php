...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"`categories`.`ot_Ref03`" => "ot_Ref03",
		"`categories`.`ot_Ref04`" => "ot_Ref04",
		"`categories`.`ot_Ref05`" => "ot_Ref05",
		"`categories`.`ot_Ref06`" => "ot_Ref06",
		"`categories`.`ot_Picture01`" => "ot_Picture01",
		"`categories`.`ot_Picture02`" => "ot_Picture02",
		"`categories`.`ot_Picture03`" => "ot_Picture03",
		"if(`categories`.`ot_ap_filed`,date_format(`categories`.`ot_ap_filed`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_filed",
		"if(`categories`.`ot_ap_lastmodified`,date_format(`categories`.`ot_ap_lastmodified`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_lastmodified"
	);
	...
	$x->SortFields = array(   
		...
		16 => 16,
		17 => 17,
		18 => '`categories`.`ot_ap_filed`',
		19 => '`categories`.`ot_ap_lastmodified`'
	);
	...
	$x->QueryFieldsFilters = array(   
		...
		"`categories`.`ot_Ref03`" => "Reference_3",
		"`categories`.`ot_Ref04`" => "Reference_4",
		"`categories`.`ot_Ref05`" => "Reference_5",
		"`categories`.`ot_Ref06`" => "Reference_6",
	...
	$x->ColWidth   = array(  150, 75, 75, 75, 150, 150);
	$x->ColCaption = array("Category Name", "Picture_1", "Picture_2", "Picture_3", "Filed", "Last modified");
	$x->ColFieldName = array('CategoryName', 'ot_Picture01', 'ot_Picture02', 'ot_Picture03', 'ot_ap_filed', 'ot_ap_lastmodified');
	$x->ColNumber  = array(2, 15, 16, 17, 18, 19);
