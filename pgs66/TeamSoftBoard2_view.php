...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	include("$currDir/TeamSoftBoard2_dml.php");
	...
	$x->QueryFieldsTV = array(   
		...
		"`TeamSoftBoard`.`image`" => "image",
		"`TeamSoftBoard`.`TextPost`" => "TextPost",
		"`TeamSoftBoard`.`website`" => "website",
		"`TeamSoftBoard`.`Ref01`" => "Ref01",
		"DATE_FORMAT(`TeamSoftBoard`.`filed`, '%c/%e/%Y %l:%i%p')" => "filed",
		"DATE_FORMAT(`TeamSoftBoard`.`last_modified`, '%c/%e/%Y %l:%i%p')" => "last_modified"
	);
	...
	$x->SortFields = array(   
		...
		5 => 5,
		6 => 6,
		7 => '`TeamSoftBoard`.`filed`',
		8 => '`TeamSoftBoard`.`last_modified`'
	);
	...
	$x->QueryFieldsFilters = array(   
		...
		"`TeamSoftBoard`.`Ref01`" => "Reference Item",
	...
	// $x->TableTitle = "Organization ";
	// $x->TableIcon = "resources/table_icons/group_link.png";
	$x->PrimaryKey = "`TeamSoftBoard`.`Postid`";
	$x->DefaultSortField = '1';
	$x->DefaultSortDirection = 'desc';

	$x->ColWidth   = array(  120, 150, 150, 150);
	$x->ColCaption = array("Post Title", "Image", "Posting Date");
	$x->ColFieldName = array('Title', 'image', 'filed');
	$x->ColNumber  = array(2, 3, 7, 8);

	// template paths below are based on the app main directory
	$x->Template = 'templates/TeamSoftBoard2_templateTV.html';
	$x->SelectedTemplate = 'templates/TeamSoftBoard2_templateTVS.html';
	$x->TemplateDV = 'templates/TeamSoftBoard2_templateDV.html';
	$x->TemplateDVP = 'templates/TeamSoftBoard2_templateDVP.html';
