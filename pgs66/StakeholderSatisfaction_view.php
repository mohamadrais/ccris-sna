...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"`StakeholderSatisfaction`.`ot_Photo`" => "ot_Photo",
		...
		"DATE_FORMAT(`StakeholderSatisfaction`.`ot_ap_filed`, '%c/%e/%Y %l:%i%p')" => "ot_ap_filed",
		"DATE_FORMAT(`StakeholderSatisfaction`.`ot_ap_lastmodified`, '%c/%e/%Y %l:%i%p')" => "ot_ap_lastmodified"
	);
	...
	$x->SortFields = array(   
		...
		26 => 26,
		27 => '`StakeholderSatisfaction`.`ot_ap_filed`',
		28 => '`StakeholderSatisfaction`.`ot_ap_lastmodified`'
	);
	...
	$x->ColNumber  = array(2, 4, 5, 6, 8, 9, 21, 23, 25, 27, 28);
