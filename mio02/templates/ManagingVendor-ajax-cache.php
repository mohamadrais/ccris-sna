<script>
	$j(function(){
		var tn = 'ManagingVendor';

		/* data for selected record, or defaults if none is selected */
		var data = {
			fo_VendorID: <?php echo json_encode(array('id' => $rdata['fo_VendorID'], 'value' => $rdata['fo_VendorID'], 'text' => $jdata['fo_VendorID'])); ?>,
		...
		/* saved value for fo_VendorID */
		cache.addCheck(function(u, d){
			if(u != 'ajax_combo.php') return false;
			if(d.t == tn && d.f == 'fo_VendorID' && d.id == data.fo_VendorID.id)
				return { results: [ data.fo_VendorID ], more: false, elapsed: 0.01 };
			return false;
		});
