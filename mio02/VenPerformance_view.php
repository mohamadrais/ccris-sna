...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"concat('<img src=\"', if(`VenPerformance`.`fo_NewList`, 'checked.gif', 'checkednot.gif'), '\" border=\"0\" />')" => "fo_NewList",
		...
		"`VenPerformance`.`ot_Photo`" => "ot_Photo",
		...
		"DATE_FORMAT(`VenPerformance`.`ot_ap_filed`, '%c/%e/%Y %l:%i%p')" => "ot_ap_filed",
		"DATE_FORMAT(`VenPerformance`.`ot_ap_lastmodified`, '%c/%e/%Y %l:%i%p')" => "ot_ap_lastmodified"
	);
	...
	$x->SortFields = array(   
		...
		30 => 30,
		31 => '`VenPerformance`.`ot_ap_filed`',
		32 => '`VenPerformance`.`ot_ap_lastmodified`'
	);
	...
	$x->ColNumber  = array(2, 3, 4, 5, 7, 25, 27, 29, 31, 32);
