...
<?php $current_table = 'membership_company'; ?>
<?php
			...
			<table class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][16]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][16]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="mailto:<?php echo isEmail($record[16]); ?>" class="btn btn-info" title="<?php echo html_attr($record[16]); ?>"><i class="glyphicon glyphicon-envelope"></i></a></td>
