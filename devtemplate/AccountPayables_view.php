...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"`AccountPayables`.`ot_Ref03`" => "ot_Ref03",
		"`AccountPayables`.`ot_Ref04`" => "ot_Ref04",
		"`AccountPayables`.`ot_Ref05`" => "ot_Ref05",
		"`AccountPayables`.`ot_Ref06`" => "ot_Ref06",
		"`AccountPayables`.`ot_Photo01`" => "ot_Photo01",
		"`AccountPayables`.`ot_Photo02`" => "ot_Photo02",
		"`AccountPayables`.`ot_Photo03`" => "ot_Photo03",
		...
		"if(`AccountPayables`.`ot_ap_filed`,date_format(`AccountPayables`.`ot_ap_filed`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_filed",
		"if(`AccountPayables`.`ot_ap_lastmodified`,date_format(`AccountPayables`.`ot_ap_lastmodified`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_lastmodified"
	);
	...
	$x->SortFields = array(   
		...
		28 => 28,
		29 => '`AccountPayables`.`ot_ap_filed`',
		30 => '`AccountPayables`.`ot_ap_lastmodified`'
	);
	...
	$x->QueryFieldsFilters = array(   
		...
		"`AccountPayables`.`ot_Ref03`" => "Reference_3",
		"`AccountPayables`.`ot_Ref04`" => "Reference_4",
		"`AccountPayables`.`ot_Ref05`" => "Reference_5",
		"`AccountPayables`.`ot_Ref06`" => "Reference_6",
