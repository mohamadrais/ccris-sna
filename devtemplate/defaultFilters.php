...
<!-- <div class="row">
	...
	<?php if($this->AllowSavingFilters){ ?>
		<div class="col-md-3 vspacer-lg">
			<button type="submit" class="btn btn-outline-plain btn-block btn-lg" id="SaveFilter" name="SaveFilter_x" value="1"><i class="glyphicon glyphicon-align-left"></i> <?php echo $Translation['save filters']; ?></button>
		</div>
	<?php } ?>
