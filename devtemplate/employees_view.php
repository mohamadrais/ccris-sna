...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"if(`employees`.`fo_OffHireDate`,date_format(`employees`.`fo_OffHireDate`,'%m/%d/%Y'),'')" => "fo_OffHireDate",
	...
	$x->QueryFieldsFilters = array(   
		...
		"`employees`.`fo_HireDate`" => "On Hire Date",
		"`employees`.`fo_OffHireDate`" => "Off Hire Date",
