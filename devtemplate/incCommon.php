...
EOT;
	...
	function get_summary_custom_display($tableName, $metricPosition){
		...
		$arrSummaryCustomDisplayList = array(
			...
			"AccountPayables" => array("Account Payables", "Total LumpSum Price for this Week", "float", "Total LumpSum Price for this Month", "float"),
