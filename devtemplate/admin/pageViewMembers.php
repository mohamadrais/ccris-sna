						...
						<table class="table">
							<thead>
											...
											<div class="row">
												<div class="col-md-2">
													<div class="input-group d-block">
														<label for="groupID" class="control-label d-block"><?php echo $Translation["group"]; ?></label>
												...
												<div class="col-md-2">
													<div class="input-group d-block">
														<label for="" class="control-label d-block"><?php echo $Translation["Status"]; ?></label>
														<?php
												...
												<div class="col-md-6">
													...
													<div class="input-group d-block">
														<label for="groupID" class="control-label d-block">Search Members</label>
														<?php 
															$originalValues =  array ('<SEARCH>','<HTMLSELECT>');
															$searchValue = '<input class="form-control d-block" style="width:85% !important;" type="text" name="searchMembers" value="' . $searchHTML . '">';
												...
												<div class="col-md-2">
													...
													<div class="button-group mt-3">
														<button class="btn btn-warning" href="pageViewMembers.php"><i class="glyphicon glyphicon-remove"></i> <?php echo $Translation['reset'] ; ?></button>
								...
								<tr>
									...
									<th><a><?php echo $Translation['sign up date'] ; ?></a></th>
									<th><a><?php echo $adminConfig['custom1']; ?></a></th>
									<th><a><?php echo $adminConfig['custom2']; ?></a></th>
									<th><a><?php echo $adminConfig['custom3']; ?></a></th>
									<th><a><?php echo $adminConfig['custom4']; ?></a></th>
									<th><a><?php echo $Translation['Status'] ; ?></a></th>
									<th>&nbsp;</th>
								</tr>
							</thead>
							<tbody>
