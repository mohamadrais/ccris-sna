	...
	*/
	...
	function getThumbnailSpecs($tableName, $fieldName, $view){
		...
		elseif($tableName=='IMSReport' && $fieldName=='image' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='membership_company' && $fieldName=='fo_Logo' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='membership_company' && $fieldName=='fo_Banner' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='membership_company' && $fieldName=='fo_Photo01' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='membership_company' && $fieldName=='fo_Photo02' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='membership_company' && $fieldName=='fo_Photo03' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		return FALSE;
	}
	########################################################################
