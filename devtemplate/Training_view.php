...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"`Training`.`ot_Location`" => "ot_Location",
		"`Training`.`ot_Ref01`" => "ot_Ref01",
		"`Training`.`ot_Ref02`" => "ot_Ref02",
		"`Training`.`ot_Ref03`" => "ot_Ref03",
		"`Training`.`ot_Ref04`" => "ot_Ref04",
		"`Training`.`ot_Ref05`" => "ot_Ref05",
		"`Training`.`ot_Ref06`" => "ot_Ref06",
		"`Training`.`ot_Photo01`" => "ot_Photo01",
		"`Training`.`ot_Photo02`" => "ot_Photo02",
		"`Training`.`ot_Photo03`" => "ot_Photo03",
		"IF(    CHAR_LENGTH(`Leadership1`.`Status`), CONCAT_WS('',   `Leadership1`.`Status`), '') /* Review */" => "ot_ap_Review",
		"`Training`.`ot_ap_RevComment`" => "ot_ap_RevComment",
		"IF(    CHAR_LENGTH(`Approval1`.`Status`), CONCAT_WS('',   `Approval1`.`Status`), '') /* Approval */" => "ot_ap_Approval",
		"`Training`.`ot_ap_ApprComment`" => "ot_ap_ApprComment",
		"IF(    CHAR_LENGTH(`IMSControl1`.`Status`), CONCAT_WS('',   `IMSControl1`.`Status`), '') /* IMS Control */" => "ot_ap_QC",
		"`Training`.`ot_ap_QCComment`" => "ot_ap_QCComment",
		"if(`Training`.`ot_ap_filed`,date_format(`Training`.`ot_ap_filed`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_filed",
		"if(`Training`.`ot_ap_lastmodified`,date_format(`Training`.`ot_ap_lastmodified`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_lastmodified"
	);
	...
	$x->SortFields = array(   
		...
		29 => 29,
		30 => '`Training`.`ot_ap_filed`',
		31 => '`Training`.`ot_ap_lastmodified`'
	);
	...
	$x->ColCaption = array("Training Record Number", "Employee", "Project Team ID", "Training Session", "Training Related Record", "Training Date", "Review", "Approval", "IMS Control", "Register", "Last modified");
	$x->ColFieldName = array('TraningNo', 'EmployeeID', 'ProjectTeamID', 'fo_TrainingSession', 'fo_Classification', 'fo_Date', 'ot_ap_Review', 'ot_ap_Approval', 'ot_ap_QC', 'ot_ap_filed', 'ot_ap_lastmodified');
	$x->ColNumber  = array(2, 3, 4, 5, 6, 8, 24, 26, 28, 30, 31);
