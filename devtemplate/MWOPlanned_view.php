...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"`MWOPlanned`.`ot_Location`" => "ot_Location",
		"`MWOPlanned`.`ot_Ref01`" => "ot_Ref01",
		"`MWOPlanned`.`ot_Ref02`" => "ot_Ref02",
		"`MWOPlanned`.`ot_Ref03`" => "ot_Ref03",
		"`MWOPlanned`.`ot_Ref04`" => "ot_Ref04",
		"`MWOPlanned`.`ot_Ref05`" => "ot_Ref05",
		"`MWOPlanned`.`ot_Ref06`" => "ot_Ref06",
		"`MWOPlanned`.`ot_Photo01`" => "ot_Photo01",
		"`MWOPlanned`.`ot_Photo02`" => "ot_Photo02",
		"`MWOPlanned`.`ot_Photo03`" => "ot_Photo03",
		...
		"if(`MWOPlanned`.`ot_ap_filed`,date_format(`MWOPlanned`.`ot_ap_filed`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_filed",
		"if(`MWOPlanned`.`ot_ap_lastmodified`,date_format(`MWOPlanned`.`ot_ap_lastmodified`,'%m/%d/%Y %h:%i %p'),'')" => "ot_ap_lastmodified"
	);
	...
	$x->SortFields = array(   
		...
		26 => 26,
		27 => '`MWOPlanned`.`ot_ap_filed`',
		28 => '`MWOPlanned`.`ot_ap_lastmodified`'
	);
	...
	$x->QueryFieldsFilters = array(   
		...
		"`MWOPlanned`.`ot_Location`" => "Location",
		"`MWOPlanned`.`ot_Ref01`" => "Reference_1",
		"`MWOPlanned`.`ot_Ref02`" => "Reference_2",
		"`MWOPlanned`.`ot_Ref03`" => "Reference_3",
		"`MWOPlanned`.`ot_Ref04`" => "Reference_4",
		"`MWOPlanned`.`ot_Ref05`" => "Reference_5",
		"`MWOPlanned`.`ot_Ref06`" => "Reference_6",
