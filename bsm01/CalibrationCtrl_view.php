...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"`CalibrationCtrl`.`ot_Photo`" => "ot_Photo",
		...
		"DATE_FORMAT(`CalibrationCtrl`.`ot_ap_filed`, '%c/%e/%Y %l:%i%p')" => "ot_ap_filed",
		"DATE_FORMAT(`CalibrationCtrl`.`ot_ap_lastmodified`, '%c/%e/%Y %l:%i%p')" => "ot_ap_lastmodified"
	);
	...
	$x->SortFields = array(   
		...
		22 => 22,
		23 => '`CalibrationCtrl`.`ot_ap_filed`',
		24 => '`CalibrationCtrl`.`ot_ap_lastmodified`'
	);
