...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"concat('<img src=\"', if(`Item`.`fo_Discontinued`, 'checked.gif', 'checkednot.gif'), '\" border=\"0\" />')" => "fo_Discontinued",
		...
		"`Item`.`ot_Photo`" => "ot_Photo",
		"DATE_FORMAT(`Item`.`ot_ap_filed`, '%c/%e/%Y %l:%i%p')" => "ot_ap_filed",
		"DATE_FORMAT(`Item`.`ot_ap_lastmodified`, '%c/%e/%Y %l:%i%p')" => "ot_ap_lastmodified"
	);
	...
	$x->ColNumber  = array(2, 3, 4, 5, 7, 12, 21, 22);
