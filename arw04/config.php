<?php
	$dbServer = 'localhost';
	$dbUsername = 'priggm80_admin';
	$dbPassword = 'JBam330716';
	$dbDatabase = 'priggm80_arw04';

	$adminConfig = array(
		'adminUsername' => "administrator",
		'adminPassword' => "200ceb26807d6bf99fd6f4f0d1ca54d4",
